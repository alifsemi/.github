...
> [!NOTE]
> **For Zephyr development on Alif Devices, users MUST start with the [Alif Zephyr SDK User Guide](https://github.com/alifsemi/sdk-alif/releases/download/v2.3.0/user_guide.pdf) in the [sdk_alif repository](https://github.com/alifsemi/sdk-alif). Please make sure you are using the latest released version.**
